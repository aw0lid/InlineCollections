...
{
    public class InlineQueue8Tests
    {
        [Fact]
        public void Constructor_InitializesEmptyQueue()
        {
            var queue = new InlineQueue8<int>();
        ...
        {
            var queue = new InlineQueue8<int>();
            for (int i = 0; i < 8; i++) queue.TryEnqueue(i);
        ...
        public void WrapAround_EnqueueAfterDequeue()
        {
            ...
            for (int i = 8; i < 12; i++) queue.Enqueue(i);
        ...
        {
            Assert.Equal(8, InlineQueue8<int>.Capacity);
        }
        ...
        public void Fill_Empty_Fill_VerifiesFullCapacity()
        {
            ...
            for (int i = 0; i < 8; i++) queue.Enqueue(i + 100);
            Assert.Equal(8, queue.Count);
        ...
        public void GetEnumerator_HandlesWrapAroundCorrectly()
        {
            ...
            for (int i = 0; i < 6; i++) queue.Enqueue(i);
            for (int i = 0; i < 4; i++) queue.Dequeue();
            for (int i = 6; i < 8; i++) queue.Enqueue(i);
        ...
        public void GetEnumerator_IteratesInCorrectOrder_AfterWrapAround()
        {
            ...
            for (int i = 0; i < 3; i++) queue.Dequeue();
            for (int i = 7; i <= 10; i++) queue.Enqueue(i);
