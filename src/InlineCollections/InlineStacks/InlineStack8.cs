...
{
    /// <summary>
    /// Provides a high-performance, stack-allocated Stack with a fixed capacity of 8 elements.
    ...
    public ref struct InlineStack8<T> where T : unmanaged, IEquatable<T>
    {
        ...
        /// <summary>
        /// The fixed capacity of the <see cref="InlineStack8{T}"/>.
        /// </summary>
        public const int Capacity = 8;

        /// <summary>
        /// Gets the number of elements contained in the <see cref="InlineStack8{T}"/>.
        /// </summary>
        public readonly int Count => _count;

        /// <summary>
        /// Returns an enumerator for the <see cref="InlineStack8{T}"/>.
        /// </summary>
        public StackEnumerator<T> GetEnumerator() => new(AsSpan(), _count);

        /// <summary>
        /// Initializes a new instance of the <see cref="InlineStack8{T}"/> struct.
        /// </summary>
        public InlineStack8()
        {
            _buffer = default;
        ...
        /// <summary>
        /// Inserts an object at the top of the <see cref="InlineStack8{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes and returns the object at the top of the <see cref="InlineStack8{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns the object at the top of the <see cref="InlineStack8{T}"/> without removing it.
        /// </summary>
        ...
        /// <summary>
        /// Removes all objects from the <see cref="InlineStack8{T}"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
