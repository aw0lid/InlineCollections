...
{
    /// <summary>
    /// Provides a high-performance, stack-allocated List with a fixed capacity of 8 elements.
    ...
    public ref struct InlineList8<T> where T : unmanaged, IEquatable<T>
    {
        ...
        /// <summary>
        /// The fixed capacity of the <see cref="InlineList8{T}"/>.
        /// </summary>
        public const int Capacity = 8;

        /// <summary>
        /// Gets the number of elements contained in the <see cref="InlineList8{T}"/>.
        /// </summary>
        public readonly int Count => _count;

        /// <summary>
        /// Returns an enumerator for the <see cref="InlineList8{T}"/>.
        /// </summary>
        public Enumerator<T> GetEnumerator() => new(AsSpan());


        /// <summary>
        /// Initializes a new instance of the <see cref="InlineList8{T}"/> struct with initial items.
        /// </summary>
        /// <param name="items">The span of items to initialize the list with.</param>
        public InlineList8(ReadOnlySpan<T> items)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineList8{T}"/> struct.
        /// </summary>
        public InlineList8()
        {
            _buffer = default;
        ...
        /// <summary>
        /// Adds an object to the end of the <see cref="InlineList8{T}"/>.
        /// High-performance: No bounds checking.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Tries to add an object to the end of the <see cref="InlineList8{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds the elements of the specified span to the end of the <see cref="InlineList8{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Inserts an element into the <see cref="InlineList8{T}"/> at the specified index.
        /// High-performance: No bounds checking.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Tries to insert an element into the <see cref="InlineList8{T}"/> at the specified index.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Removes the first occurrence of a specific object from the <see cref="InlineList8{T}"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Determines whether an element is in the <see cref="InlineList8{T}"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Contains(T item) => InlineListCore.Contains(in item, _buffer, _count);

        /// <summary>
        /// Removes all objects from the <see cref="InlineList8{T}"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
