...
namespace Benchmarks
{
    ...
    public class InlineStack16Benchmark
    {
        ...
        {
            var stack = new Stack<int>(data16);
            int sum = 0;
            for (int i = 0; i < OperationsPerInvoke; i++)
            {
                sum += stack.Peek();
        ...
        public void InlineStack_FillAndEmpty()
        {
            ...
            {
                var stack = new InlineStack16<int>();
                for (int j = 0; j < 16; j++) stack.Push(j);
                for (int j = 0; j < 16; j++) stack.Pop();
            }
        }
        ...
        {
            BenchmarkRunner.Run<InlineStack16Benchmark>();
        }
    }
}