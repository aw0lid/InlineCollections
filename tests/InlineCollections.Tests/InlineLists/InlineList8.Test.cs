...
namespace InlineCollections.Tests
{
    public class InlineList8Tests
    {
        ...
        public void AddRange_ExceedCapacity_ThrowsInvalidOperationException()
        {
            ...
            int[] items = new int[] { 1, 2, 3, 4 }; // Total 10, exceeds 8
        ...
        public void TryInsert_FullList_ReturnsFalse()
        {
            ...
            bool result = list.TryInsert(4, 999);
        ...
        public void TryInsert_AtCountIndex_WhenFull_ReturnsFalse()
        {
            ...
            bool result = list.TryInsert(8, 999);
        ...
        {
            Assert.Equal(8, InlineList8<int>.Capacity);
        }
        ...
        [Fact]
        public void AddRange_Exactly8Items_Succeeds()
        {
            var list = new InlineList8<int>();
            Span<int> items = stackalloc int[8];
        ...
        {
            var list = new InlineList8<int>();
            for (int i = 0; i < 8; i++) list.Add(0);

            list[7] = 777;
            Assert.Equal(777, list[7]);
        }
        ...
        public void Remove_NonExistentItem_ReturnsFalseAndKeepsState()
        {
            ...
            bool result = result = list.Remove(3);
        ...
        public void Constructor_WithSpan_CopiesDataCorrectly()
        {
            ...
            var list = new InlineList8<int>(source);
        ...
        {
            ReadOnlySpan<int> source = stackalloc int[9];
            bool threw = false;
            try
            {
                var list = new InlineList8<int>(source);
