...
{
    public class InlineStack16Tests
    {
        [Fact]
        ...
        {
            var stack = new InlineStack16<int>();
            for (int i = 0; i < 16; i++) stack.TryPush(i);
        ...
        {
            Assert.Equal(16, InlineStack16<int>.Capacity);
        }
        ...
        {
            var stack = new InlineStack16<TestPoint>();
        ...
        public void FullStack_Operations_AtBoundary()
        {
            ...
            Assert.Equal(16, stack.Count);
            Assert.Equal(16, stack.AsSpan().Length);
            Assert.Equal(15, stack.Peek());

            Assert.Equal(15, stack.Pop());
            Assert.Equal(15, stack.Count);
        }
        ...
        {
            var stack = new InlineStack16<OddSizeStruct>();
