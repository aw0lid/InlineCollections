...
{
    /// <summary>
    /// Provides a high-performance, stack-allocated Stack with a fixed capacity of 16 elements.
    ...
    public ref struct InlineStack16<T> where T : unmanaged, IEquatable<T>
    {
        private InlineArray16<T> _buffer;
        private int _count;

        /// <summary>
        /// The fixed capacity of the <see cref="InlineStack16{T}"/>.
        /// </summary>
        public const int Capacity = 16;

        /// <summary>
        /// Gets the number of elements contained in the <see cref="InlineStack16{T}"/>.
        /// </summary>
        public readonly int Count => _count;

        /// <summary>
        /// Returns an enumerator for the <see cref="InlineStack16{T}"/>.
        /// </summary>
        public StackEnumerator<T> GetEnumerator() => new(AsSpan(), _count);

        /// <summary>
        /// Initializes a new instance of the <see cref="InlineStack16{T}"/> struct.
        /// </summary>
        public InlineStack16()
        {
            _buffer = default;
            _count = 0;
        }
        ...
        /// <summary>
        /// Inserts an object at the top of the <see cref="InlineStack16{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes and returns the object at the top of the <see cref="InlineStack16{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns the object at the top of the <see cref="InlineStack16{T}"/> without removing it.
        /// </summary>
        ...
        /// <summary>
        /// Removes all objects from the <see cref="InlineStack16{T}"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
