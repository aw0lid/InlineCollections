...
{
    /// <summary>
    /// Provides a high-performance, stack-allocated Queue with a fixed capacity of 16 elements.
    ...
    public ref struct InlineQueue16<T> where T : unmanaged, IEquatable<T>
    {
        ...
        /// <summary>
        /// The fixed capacity of the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        public const int Capacity = 16;
        private const int Mask = Capacity - 1;

        /// <summary>
        /// Gets the number of elements contained in the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        public readonly int Count => _count;

        /// <summary>
        /// Returns an enumerator for the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        public QueueEnumerator<T> GetEnumerator() => new(AsSpan(), _head, _count, Mask);

        /// <summary>
        /// Initializes a new instance of the <see cref="InlineQueue16{T}"/> struct.
        /// </summary>
        public InlineQueue16()
        {
            _buffer = default;
            _head = 0;
            _tail = 0;
        ...
        /// <summary>
        /// Adds an object to the end of the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Tries to add an object to the end of the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        /// <param name="item">The object to add to the queue.</param>
        ...
        /// <summary>
        /// Removes and returns the object at the beginning of the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Tries to remove and return the object at the beginning of the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns the object at the beginning of the <see cref="InlineQueue16{T}"/> without removing it.
        /// </summary>
        ...
        /// <summary>
        /// Removes all objects from the <see cref="InlineQueue16{T}"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Clear()
        {
